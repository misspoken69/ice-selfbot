...
if (command === "translist") {
    ...
    msg.channel.send(embed);
     ...
     if (command === "help"){
        ...
        if (args.length < 1){
         let embed = new Discord.RichEmbed()
                .setDescription("`Prefix:` `x` `made by:` `Syrux` `Credits: XS Clan`")
                .setAuthor("༺Ｓｙｒｕｘ Ｓｅｌｆｂｏｔ༻")
                .setColor("#000000")
                .setThumbnail('https://media.discordapp.net/attachments/768152992905822250/784055327980912640/Sg_Zack1354_GIF-downsized_large.gif')
                .setTimestamp()
                .addField(`ℂ𝕆𝕄𝕄𝔸ℕ𝔻𝕊`, '`HELP TEXT` `HELP SPAMMER` `HELP FUN` `HELP FUN2` `HELP INFO` `HELP NUKE` `HELP SETUP`')
               .addField(`ℙ𝟙 𝕊𝔹 𝔹𝔸𝔹𝕐`, '`✅NITRO SNIPER`  `✅MESSAGE LOGGER`')
